package com.rhp.userperm.config;

import com.rhp.userperm.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        filterMap.put("/userUpdate", "perms[user:update]"); //当前用户没有这权限，用来对比的
        filterMap.put("/articleAdd", "perms[article:add]");
        ...
        filterBean.setLoginUrl("/login");  //如果不设置默认会自动寻找Web工程根目录下的"/login.jsp"页面
